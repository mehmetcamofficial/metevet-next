  ...
  return (
    <section className="px-6 pb-20 sm:pb-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-[2rem] border border-[#0D2922]/10 bg-white p-8 shadow-[0_20px_60px_rgba(13,41,34,0.08)] lg:grid-cols-[0.9fr_1.1fr] lg:p-10">
        ...
        <Reveal delay={0.08}>
          <div className="rounded-[1.5rem] border border-[#0D2922]/10 bg-[#F4F0E8] p-6">
            <div className="rounded-[1.2rem] border border-[#0D2922]/10 bg-white p-6 text-center">
              ...
              <Link href={locale === "tr" ? "/tr/iletisim" : "/en/contact"} className="mt-6 inline-flex items-center rounded-full bg-[#123A30] px-5 py-3 text-sm font-semibold text-white transition hover:brightness-110">{dict.common.learnMore}</Link>
            </div>
          </div>
        </Reveal>
      </div>
