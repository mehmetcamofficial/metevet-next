...
export default async function Detail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AdminShell session={session}>
    ...
    <DocumentCreateLinks role={session.profile.role} links={[{label:"Randevu Özeti Oluştur",type:"appointment_summary",source:id,preview:`/admin/documents/appointment/${id}`}]}/>
  </AdminShell>;
}
